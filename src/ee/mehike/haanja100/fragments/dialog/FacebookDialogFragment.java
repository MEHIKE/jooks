...
public class FacebookDialogFragment extends DialogFragment implements View.OnClickListener {

	public static FacebookDialogFragment newInstance(int fbResId, long rec_id, String text) {
		FacebookDialogFragment hdf = new FacebookDialogFragment();
	...
	public static FacebookDialogFragment newInstance(int fbResId, long rec_id) {
		FacebookDialogFragment hdf = new FacebookDialogFragment();
		Bundle bundle = new Bundle();
		bundle.putInt("fb_resource", fbResId);
		bundle.putLong("rec_id", rec_id);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle icicle) {
		...
		vv = inflater.inflate(R.layout.fb_dialog, container, false);
	...
	public void onClick(View v) {
		...
		if (v.getId() == R.id.btn_send) {
			...
			TextView tv = (TextView)vv.findViewById(R.id.fbmessage);
			act.onFbDialogDone(this.getTag(), false, tv.getText(), rec_id);
